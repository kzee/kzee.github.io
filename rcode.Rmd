...
More R code is available on my [Github page](https://github.com/kzee){target="_blank"}, including the R code used to generate this website!
...
This demo shows how to test whether two regression coefficients are significantly different from each other. 
